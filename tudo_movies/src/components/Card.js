...
export default class Card extends Component {
  ...
  render() {
    ...
    return (
      <div className="card" >
        <img className="img-back" src={base_url + size + movie.backdrop_path} alt={'Imagem: '+ movie.title}/>

        <img className="img-min" src={base_url + size + movie.poster_path} alt={'Poster: '+ movie.title}/>
